...
const nameGreeting = nameCheck('Jason');
...
//CODE HERE
const thatsOdd = (argument) => {
  return (argument % 2 == 0 ? "That's not odd!" : "That is odd indeed!")
}
...
*/
let myEmail = "   jermos88yahoo.com   ";

const emailCheck = (email) => {
  String(myEmail), myEmail.trim();
  if (myEmail.includes("@")){
...
const maxFrogs = (purse) => {
  let frogPrice = 3;
    return purse / 3 
}
console.log(maxFrogs(14));
////////////////// PROBLEM 20 ////////////////////
/*
...
//CODE HERE
const maxFrogs2 = (purse) => {
  let frogPrice = 3; 
  return Math.floor(purse / 3)
}
let totalFrogs2 = maxFrogs2(14)
